...
> - `Skip the rename, keep the auto subdomain` — the deployment is already live on the random `<random>.opendeploy.run` from Step 7. Print that URL as the final report and exit `0`.
